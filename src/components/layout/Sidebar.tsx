...
const navItems = [
  ...
  { href: "/promotions",    label: "Promosi",    badge: false, permission: "promo.read" },
...
const icons: Record<string, React.ReactNode> = {
  ...
  "/promotions":    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>,
